...
if ( isset( $portfolio['style'] ) && !empty( $portfolio['style'] ) && $styles[$portfolio['style']]['data'] ) {
	...
	/* Modify column and row space - ".my-pf-posts-wrap-inner" */
	$css_prop = null;
	...
	if ( $css_prop ) { echo sprintf( '%1$s .my-pf-posts-wrap-inner { %2$s }', $id_prefix, $css_prop ) . "\n"; }
	...
	if ( $css_prop ) { echo sprintf( '%1$s .my-pf-filter-opacity .my-pf-col-wrap.my-pf-disabled { %2$s }', $id_prefix, $css_prop ) . "\n"; }

	/* Modify column and row space - ".my-pf-post-col" */
	$css_prop = null;
	if ( isset( $portfolio['h-space'] ) && !empty( $portfolio['h-space'] ) ) {
	...
	if ( $css_prop ) { echo sprintf( '%1$s .my-pf-post-col { %2$s }', $id_prefix, $css_prop ) . "\n"; }

	/* Modify space between portfolio filter and portfolio items - ".my-pf-cats > div" */
	$css_prop = null;
	...
	if ( $css_prop ) { echo sprintf( '%1$s .my-pf-cats { %2$s }', $id_prefix, $css_prop ) . "\n"; }	
	
	/* Modify left space for portfolio filter categories - ".my-pf-filter" */
	$css_prop = null;
	...
	if ( $css_prop ) { echo sprintf( '%1$s .my-pf-filter { %2$s }', $id_prefix, $css_prop ) . "\n"; }
	
	/* Modify space between portfolio filter categories - ".my-pf-cats > div" */
	$css_prop = null;
	if ( isset( $portfolio['filter-h-space'] ) && !empty( $portfolio['filter-h-space'] ) ) {
		$css_prop = 'margin-left:' . floatval( $portfolio['filter-h-space'] ) . 'px;';
	}
	if ( $css_prop ) { echo sprintf( '%1$s .my-pf-cats > span { %2$s }', $id_prefix, $css_prop ) . "\n"; }
	
	/* Modify slider arrow spaces - ".my-pf-slider-controls > div" */
	$css_prop = null;
	...
	if ( $css_prop ) { echo sprintf( '%1$s .my-pf-slider-controls > div { %2$s }', $id_prefix, $css_prop ) . "\n"; }	
	...
	/* Modify overlay color - ".my-pf-post-overlay-bg" */
	$css_prop = null;
	...
	if ( $css_prop ) { echo sprintf( '%1$s .my-pf-post-overlay-bg { %2$s }', $id_prefix, $css_prop ) . "\n"; }	

	/* Modify overlay opacity - ".my-pf-post-overlay-bg" */
	$css_prop = null;
	...
	/* Modify post content align - ".my-pf-post-content" */
	$css_prop = null;
	if ( isset( $portfolio['post-align'] ) && !empty( $portfolio['post-align'] ) ) {
		$css_prop = 'text-align:' . $portfolio['post-align'] . ';';
	}
	if ( $css_prop ) { echo sprintf( '%1$s .my-pf-post-content { %2$s }', $id_prefix, $css_prop ) . "\n"; }

	/* Modify button align - ".my-pf-post-more" */
	$css_prop = null;
	if ( isset( $portfolio['post-button-align'] ) && !empty( $portfolio['post-button-align'] ) ) {
		$css_prop = 'text-align:' . $portfolio['post-button-align'] . ';';
	}
	if ( $css_prop ) { echo sprintf( '%1$s .my-pf-post-more { %2$s }', $id_prefix, $css_prop ) . "\n"; }	
	
	/* Modify space between portfolio pagination and portfolio items - ".my-pf-pagination-wrapper" */
	$css_prop = null;
	...
	if ( $css_prop ) { echo sprintf( '%1$s .my-pf-pagination-wrapper { %2$s }', $id_prefix, $css_prop ) . "\n"; }		

	/* Modify column and row space - ".my-pf-post-media-wrap" */
	$css_prop = null;
	...
	if ( $css_prop ) { echo sprintf( '%1$s .my-pf-post-media-wrap { %2$s }', $id_prefix, $css_prop ) . "\n"; }
